"""
Handles example bar charts for the pubg page.
Only used once to generate the examples.
"""
...
def create_example_bar_kills():
    """
    Creates example kills bar chart for pubg page.
    """
    kills = px.bar(
...
def create_example_bar_damage():
    """
    Creates example damage bar chart for pubg page.
    """
    damage = px.bar(
        data_frame=df_example, # which df  to use
        x="Season", # which column for the x-axis
...
def create_example_bar_distance():
    """
    Creates example distance bar chart for pubg page.
    """
    distance = px.bar(
        data_frame=df_example, # which df  to use
        x="Season", # which column for the x-axis
